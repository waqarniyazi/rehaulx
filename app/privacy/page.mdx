    ...
    <PolicyLayout title="Privacy Policy" lastUpdated="August 24, 2025">
      <div className="prose prose-invert max-w-none">
        ...
        <ul className="list-disc list-inside text-white/80 mb-4 space-y-2 ml-4">
          <li>Create an account with ReHaulX</li>
          <li>Use our AI content repurposing services</li>
        ...
        <ul className="list-disc list-inside text-white/80 mb-4 space-y-2 ml-4">
          <li><strong className="text-white font-semibold">Account Information</strong>: Name, email address, password</li>
          <li><strong className="text-white font-semibold">Profile Data</strong>: User preferences, content creation history</li>
          <li><strong className="text-white font-semibold">Payment Information</strong>: Billing details (processed securely through third-party providers)</li>
